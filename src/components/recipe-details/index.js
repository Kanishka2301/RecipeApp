...
export default function RecipeDetailsItem({ getRecipeDetails }) {
  return (
    <div>
      ...
      <div className="p-6 lg:mac-w-xl max-w-2xl mx-auto">
        <div className="grid items-start grid-cols-1 lg:grid-cols-2 ap-10">
          <div className="w-full lg:sticky top-0 sm:flex ap-2">
            <img
